...
-- Listage des données de la table jobboard.application : ~5 rows (environ)
...
-- Listage des données de la table jobboard.company : ~28 rows (environ)
...
-- Listage des données de la table jobboard.user : ~5 rows (environ)
